...
class TransformerEncoderLayerBase(nn.Module):
    ...
    *cfg.encoder.normalize_before* to ``True``.
    ...
    def turn_calibration_mode_encoder(self, att_cali):
        self.self_attn.turn_calibration_mode(att_cali)

    # def set_confidence_encoder(self, confidence):
    #     self.self_attn.set_confidence(confidence)
...
class TransformerDecoderLayerBase(nn.Module):
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def turn_calibration_mode_decoder(self, att_cali):
        self.self_attn.turn_calibration_mode(att_cali)

    def turn_calibration_mode_decoder_enc_ref(self, att_cali):
        self.encoder_attn.turn_calibration_mode(att_cali)
    
    def set_confidence_decoder(self, confidence):
        self.self_attn.set_confidence(confidence)
